...
public class RESULT implements AccessPath{
    private static AccessPath _instance = new RESULT();
    ...
    private Pattern _pattern = Pattern.compile("Result (.*)");
    @Override
