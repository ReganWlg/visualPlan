...
public class LIMIT implements AccessPath{
    private static AccessPath _instance = new LIMIT();
    ...
    private Pattern _pattern = Pattern.compile("Limit (.*)");
    @Override
