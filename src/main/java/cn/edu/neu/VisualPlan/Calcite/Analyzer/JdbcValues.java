...
public class JdbcValues implements AccessPath{
    private static AccessPath _instance = new JdbcValues();
    ...
    private Pattern _pattern = Pattern.compile("JdbcValues(.*)");
    @Override
