...
public class JdbcProject implements AccessPath{
    private static AccessPath _instance = new JdbcProject();
    ...
    private Pattern _pattern = Pattern.compile("JdbcProject(.*)");
    @Override
