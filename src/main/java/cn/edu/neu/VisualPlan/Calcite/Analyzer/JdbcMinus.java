...
public class JdbcMinus implements AccessPath{
    private static AccessPath _instance = new JdbcMinus();
    ...
    private Pattern _pattern = Pattern.compile("JdbcMinus(.*)");
    @Override
