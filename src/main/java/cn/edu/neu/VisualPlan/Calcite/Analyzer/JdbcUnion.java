...
public class JdbcUnion implements AccessPath{
    private static AccessPath _instance = new JdbcUnion();
    ...
    private Pattern _pattern = Pattern.compile("JdbcUnion(.*)");
    @Override
