...
public class TABLE_SCAN implements AccessPath {
    private static AccessPath _instance = new TABLE_SCAN();
    ...
    private Pattern _pattern = Pattern.compile("Table scan on (.*)");
    @Override
