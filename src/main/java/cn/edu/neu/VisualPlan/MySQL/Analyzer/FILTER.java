...
public class FILTER implements AccessPath {
    private static AccessPath _instance = new FILTER();
    ...
    private Pattern _pattern = Pattern.compile("Filter: (.*)");
    @Override
